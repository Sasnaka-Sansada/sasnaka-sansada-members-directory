...
function PrvtAcc({label1}) {
    return (
        <div className="flex flex-row justify-around bg-white border border-gray-300 rounded-lg overflow-hidden pb-3  mx-1" style={{ width: '22rem' }}>
        <div className='w-1/2'>
          <ProfilePic />
        </div>
